    ...
    <div class="row">
        ...
        <div class="col-md-11">
            <div style="display: inline" class="input-group mb-3">
                <form style="display: flex" action="{{route('categorias.search')}}" method="post">
                    @csrf
                    <input name="text" type="text" class="form-control" placeholder="Procure por uma categoria" aria-label="Example text with button addon" aria-describedby="button-addon1">
                    <button type="submit" class="btn btn-outline-secondary input-group-btn" type="button" id="button-addon1">
